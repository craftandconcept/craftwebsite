    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-9">
                <p class="h4">Create new collaborators</p>

                <form method="POST" class="project-form" enctype="multipart/form-data" action="{{route('collaborators.store')}}">
                    @csrf
                    ...
                    <div class="input-group mb-3 increment">
                        ...
                        <div class="custom-file">
                            <input type="file" name="main_image" required class="custom-file-input">
